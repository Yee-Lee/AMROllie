...
<head>
    ...
    <title>AMROllie standalone portal (example) MotorScan</title>
    <style>
...
<body>
    <h1>AMROllie standalone portal (example) MotorScan</h1>
    <p class="subtitle">Select a diagnostic module:</p>
    <div class="grid">
        <a href="/scan" class="card">
            <div class="card-title">Motor Scanner UI</div>
            <div class="tip">Automated PWM/RPM characterization tool.</div>
        </a>
    </div>
</body>
</html>

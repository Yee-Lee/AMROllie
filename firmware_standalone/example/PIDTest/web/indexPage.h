...
<head>
    ...
    <title>AMROllie standalone portal (example) PIDTest</title>
    <style>
...
<body>
    <h1>AMROllie standalone portal (example) PIDTest</h1>
    <p class="subtitle">Select a diagnostic module:</p>
    <div class="grid">
        <a href="/pid" class="card">
            <div class="card-title">PID Tuner UI</div>
            <div class="tip">Automated PID tuning and step response visualization.</div>
        </a>
    </div>
</body>
</html>

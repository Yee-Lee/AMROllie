...
```bash
cat ~/workspace/AMROllie/host_2204/ros2_ws/src/ldlidar_stl_ros2/launch/ld19.launch.py
```
...
**1. 載入工作區環境**
```bash
cd ~/workspace/AMROllie/host_2204/ros2_ws
...
```bash
cd ~/workspace/AMROllie/host_2204/ros2_ws/src

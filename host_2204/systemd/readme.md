...
```bash
cd ~/workspace/AMROllie/host_2204/systemd
./install_services.sh
```
...
```bash
cd ~/workspace/AMROllie/host_2204/systemd/system
...
*   **絕對路徑**：找到 `ExecStart=` 內的 `/home/<your_username>/workspace/AMROllie/host_2204/`，將其替換為專案在您機器上的真實絕對路徑。
...
```bash
# 建立軟連結
sudo ln -s ~/workspace/AMROllie/host_2204/systemd/system/ollie_microros.service /etc/systemd/system/
sudo ln -s ~/workspace/AMROllie/host_2204/systemd/system/ollie_description.service /etc/systemd/system/
sudo ln -s ~/workspace/AMROllie/host_2204/systemd/system/ollie_lidar.service /etc/systemd/system/
# 如果要部署看門狗：
sudo ln -s ~/workspace/AMROllie/host_2204/systemd/system/ollie_watchdog.service /etc/systemd/system/
```
